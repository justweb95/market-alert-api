...
export function resetPaBrowserContext(): void {
...
async function fetchPaHtmlInner(targetUrl: string): Promise<string> {
...
export async function fetchPaHtml(targetUrl: string): Promise<string> {
  try {
...
export function killPaBrowser(): void {
